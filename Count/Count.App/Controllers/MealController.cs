...
using Count.App.Models.MealFood;
...
namespace Count.App.Controllers
{
    public class MealController : Controller
    {
        ...
        public MealController(IMealService service, IFoodService serviceFood)
        {
            _service = service;
        ...
        {
            var user = await _service.FindUserByUsername(User.Identity.Name);
            var list = new FoodsOfMealViewModel();
            list.FoodsOfMeal = await _service.AllFoodsOfMeal(id);
            return View(list);
        }
